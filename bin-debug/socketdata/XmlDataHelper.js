...
(function (GreedySnakesController) {
    ...
    (function (socketdata) {
        var XmlDataHelper = (function () {
            ...
            /**
             * <LoginSuccess> <root> <success> 此处没有用
             */
            ...
            XmlDataHelper.isPlayInfoXml = function (reXML_xml) {
                var tempList = new Array();
                var tempStr = "";
                tempList.push("PlayAngle");
                // 根节点的孩子
                var firstChild = reXML_xml.children;
                var sencondChild = null;
                var onetNode = null;
            ...
            XmlDataHelper.dateHelper = function (xmlStr) {
                ...
                if (xml != null && xml != undefined) {
                    ...
                    if (hasChildNodesFlg) {
                        ...
                        else if (messageQuFen == "PlayAngle") {
                            tempList = this.isPlayInfoXml(xml);
                        }
                    }
                }
                return tempList;
        ...
        __reflect(XmlDataHelper.prototype, "GreedySnakesController.socketdata.XmlDataHelper");
